...
__all__ = ["compute_transit_depth_1_5d_ck_trans"]


def compute_transit_depth_1_5d_ck_trans(
    ...
    """Compute separate east/west CK-TRANS transmission spectra for transit_1_5d."""
