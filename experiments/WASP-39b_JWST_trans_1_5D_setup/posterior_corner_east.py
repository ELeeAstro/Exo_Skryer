...
def main() -> None:
    ap = argparse.ArgumentParser(description="Corner plot for joint + east posterior parameters.")
    ap.add_argument("--posterior", type=str, default="posterior.nc")
    ap.add_argument("--config", type=str)
    ap.add_argument("--log-params", nargs="+")
    ap.add_argument("--outname", type=str, default="posterior_corner_east")
    ...
    params = _resolve_joint_and_limb_params(posterior_path, "_east")
    plot_corner(
        posterior_path,
        params=params,
